...
void Font::SetThemeColor(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void Font::SetTintAndShade(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void Font::SetThemeFont(long nNewValue)
{
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x93f, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
		 nNewValue);
}
